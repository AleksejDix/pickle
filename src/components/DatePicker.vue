  ...
  <div>
    <article class="mx-auto max-w-md border rounded-lg p-3 shadow">
      <header>
        ...
        <div>
          <PickleUnit v-model:picked="pickle.picked" :timeunit="year" />
...
import PickleUnit from "./PickleUnit.vue";
import PickleGrid from "./PickleGrid.vue";
import PickleCell from "./PickleCell.vue";
